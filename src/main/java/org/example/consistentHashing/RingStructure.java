...
import org.example.Server.NodesReplicasMapping;
...
public class RingStructure {
    ...
    public Map<Integer, Integer> nodes_Ports = new HashMap<>();
    ...
    // fixed to 10
    public void buildMap(int numberOfVirtualNodes) {
