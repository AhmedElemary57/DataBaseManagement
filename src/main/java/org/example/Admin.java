...
public class Admin {
    public static void startServers(List<Integer> data) throws IOException {
        ...
        try {
            FileWriter myWriter = new FileWriter("/home/al-sharif-mohamed/IdeaProjects/DataBaseManagement/src/main/java/org/example/test.sh");
            myWriter.write("#!/bin/bash\n" +
                    "for i in {1.." + data.get(0) + "}\n" +
                    "do\n" +
                    "   gnome-terminal -- bash -c \"java -jar /home/al-sharif-mohamed/IdeaProjects/DataBaseManagement/out/artifacts/DataBaseManagement_jar/DataBaseManagement.jar $i "
